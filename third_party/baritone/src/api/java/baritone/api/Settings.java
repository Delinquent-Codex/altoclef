...
public final class Settings {
    ...
    /**
     * Master switch for all Baritone world visualization. Pathfinding and movement continue when disabled.
     */
    public final Setting<Boolean> renderBaritoneVisuals = new Setting<>(true);

    /**
     * Periodically log bounded native-render ownership counters for regression testing.
     */
    public final Setting<Boolean> renderDiagnostics = new Setting<>(false);
